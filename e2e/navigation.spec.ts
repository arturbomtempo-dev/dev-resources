...
import { navigateAndWait, waitForPageLoad, openMobileMenuIfNeeded } from './helpers/test-utils';
...
test.describe('Navigation', () => {
    ...
    test('should navigate to projects page', async ({ page }) => {
        ...
        await page
            .getByRole('link', { name: /projetos|projects/i })
            .first()
            .click();
        await waitForPageLoad(page);
    ...
    test('should navigate to about page', async ({ page }) => {
        ...
        await page
            .getByRole('link', { name: /sobre|about/i })
            .first()
            .click();
        await waitForPageLoad(page);
